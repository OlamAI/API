...
import modelExecuter_pb2 as modelExecuter__pb2
...
class ModelRunnerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RunModel = channel.unary_unary(
        ...
        request_serializer=modelExecuter__pb2.RunModelMessage.SerializeToString,
...
def add_ModelRunnerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RunModel': grpc.unary_unary_rpc_method_handler(
          servicer.RunModel,
          request_deserializer=modelExecuter__pb2.RunModelMessage.FromString,
